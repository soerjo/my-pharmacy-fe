...
import { admissionSchema, type AdmissionFormValues, type Admission } from "@/features/admission/types";
import { useAdmissions } from "@/features/admission/hooks";
...
export function AdmissionForm({ admission, onClose }: AdmissionFormProps) {
  ...
  if (patientSearch.trim()) {
    params.set("search", patientSearch.trim());
  }
